    ...
    <div className="staff-dashboard" style={{ padding: '20px' }}>
      ...
      <div className="quick-stats" style={{ 
        ...
        <div style={{
          ...
          <div style={{ fontSize: '24px', fontWeight: 'bold', color: '#19c37d' }}>15</div>
        ...
        <div style={{
          ...
          <div style={{ fontSize: '24px', fontWeight: 'bold', color: '#6ab7ff' }}>245</div>
        ...
        <div style={{
          ...
          <div style={{ fontSize: '24px', fontWeight: 'bold', color: '#ffa500' }}>1,234</div>
        ...
        <div style={{
          ...
          <div style={{ fontSize: '24px', fontWeight: 'bold', color: '#9c88ff' }}>98.5%</div>
