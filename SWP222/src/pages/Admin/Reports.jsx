  ...
  useEffect(() => {
    const mockData = {
      overview: {
        ...
        totalTransactions: 15689,
        totalBatteries: 1200,
        totalStations: 25,
        activeUsers: 8935,
        avgTransactionValue: 156000,
        revenueGrowth: 15.3,
        userGrowth: 22.7
      },
      revenue: {
        daily: [
          ...
          { date: '2024-01-04', amount: 95000000 },
          { date: '2024-01-05', amount: 88000000 },
          { date: '2024-01-06', amount: 102000000 },
          { date: '2024-01-07', amount: 96000000 }
        ],
        byStation: [
          { station: 'Trạm Quận 1', amount: 450000000, transactions: 2890 },
          { station: 'Trạm Quận 3', amount: 380000000, transactions: 2435 },
          { station: 'Trạm Bình Thạnh', amount: 420000000, transactions: 2698 },
          { station: 'Trạm Phú Nhuận', amount: 320000000, transactions: 2056 },
          { station: 'Trạm Tân Bình', amount: 280000000, transactions: 1798 }
        ]
      },
      usage: {
        peakHours: [
          { hour: '06:00', count: 125 },
          { hour: '07:00', count: 245 },
          { hour: '08:00', count: 398 },
          { hour: '09:00', count: 298 },
          { hour: '17:00', count: 456 },
          { hour: '18:00', count: 523 },
          { hour: '19:00', count: 398 }
        ],
        batteryStatus: {
          excellent: 856,
          good: 234,
        ...
        stationUtilization: [
          { station: 'Trạm Quận 1', utilization: 87 },
          { station: 'Trạm Quận 3', utilization: 76 },
          { station: 'Trạm Bình Thạnh', utilization: 92 },
          { station: 'Trạm Phú Nhuận', utilization: 68 },
          { station: 'Trạm Tân Bình', utilization: 45 }
        ]
      },
      customers: {
        demographics: {
